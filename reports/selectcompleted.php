...
/**
 * $Id: selectcompleted.php,v 1.3 2004/12/06 17:20:36 madbear Exp $
 * 
 ...
 * 
 * ../reports/selectcompleted.php
 * 
 * select options for report of completed tasks
 * 
 * TODO:
 */
...
$block1->openContent();
echo "<table>\n";
echo "<tr class=\"odd\"><td valign=\"top\" class=\"leftvalue\">" . $strings["assigned_to"] . " :</td><td>";
...
echo "</select></td></tr><tr class=\"odd\"><td valign=\"top\" class=\"leftvalue\">" . $strings["complete_date"] . " :</td><td>";
