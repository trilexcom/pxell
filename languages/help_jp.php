...
/**
 * $Id: help_jp.php,v 1.1 2005/01/12 07:59:54 luiswang Exp $
 * 
...
$help['task_scope_creep'] = 'Difference in hours between actual time and estimated time (bold if positive)';
$help['max_file_size'] = 'Maximum file size of a file to upload';
$help['project_disk_space'] = 'Total size of files for the project';
$help['project_scope_creep'] = 'Difference in hours between actual time and estimated time (bold if positive). Total for all tasks';
