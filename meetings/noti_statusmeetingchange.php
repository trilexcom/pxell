...
/**
 * $Id: noti_statusmeetingchange.php,v 1.2 2004/12/13 00:18:23 madbear Exp $
 * 
...
for ($i = 0; $i < $comptListNotifications; $i++) {
    if ($listNotifications->not_statusmeetingchange[$i] == "0") {
        $count1++;
    }
}
...
if ($count1 > 0) {
    ...
    $mail->partSubject = $strings["noti_statusmeetingchange1"];
    $mail->partMessage = $strings["noti_statusmeetingchange2"];
