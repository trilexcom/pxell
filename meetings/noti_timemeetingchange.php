...
/**
 * $Id: noti_timemeetingchange.php,v 1.2 2004/12/13 00:18:23 madbear Exp $
 * 
...
for ($i = 0; $i < $comptListNotifications; $i++) {
    if ($listNotifications->not_timemeetingchange[$i] == "0") {
        $count1++;
    }
}
...
if ($count1 > 0) {
    ...
    $mail->partSubject = $strings["noti_timemeetingchange1"];
    $mail->partMessage = $strings["noti_timemeetingchange2"];
